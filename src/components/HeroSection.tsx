...
export function HeroSection({ onNavigateToPayment }: HeroSectionProps = {}) {
  ...
  // Use mobile vertical alignment if on mobile
  const sectionClasses = isMobile
    ? "relative min-h-screen flex items-start justify-center overflow-hidden p-0 m-0"
  ...
  return (
    <section id="home" className={sectionClasses}>
      ...
      {/* Content */}
      <div className={`relative z-20 w-full max-w-4xl mx-auto px-2 sm:px-4 lg:px-8 text-center ${isMobile ? "pt-0 mt-0" : ""}`}>
